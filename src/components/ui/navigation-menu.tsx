...
>(({ className, children, ...props }, ref) => (
	<NavigationMenuPrimitive.Trigger
		ref={ref}
		className={cn(
			"group inline-flex items-center justify-center text-muted-foreground font-semibold gap-0.5 data-[state=open]:text-white transition-all",
			"group",
			className
		)}
		{...props}
	>
		...
		{""}
		<ChevronDownIcon
			className="relative top-[1px] ml-1 h-3 w-3 transition duration-300 group-hover:text-white group-data-[state=open]:text-green-500 group-data-[state=open]:rotate-180"
			aria-hidden="true"
		/>
	</NavigationMenuPrimitive.Trigger>
));
